...
static int count_num(short int num, int negative)
{
    int ret = 0;
...
static char *add_nb(signed char num, int negative)
{
    int i = 0;
...
char *signed_int_to_string(signed char num)
{
    char *ret = NULL;
    int negative = OFF;
...
{
    char *ret = NULL;
    signed char nb = (signed char)va_arg(c, int);
    char *temp = NULL;
