...
static int count_num(long int num, int negative)
{
    int ret = 0;
...
static char *add_nb(long int num, int negative)
{
    int i = 0;
...
char *long_int_to_string(long int num)
{
    char *ret = NULL;
    int negative = OFF;
...
{
    char *ret = NULL;
    long int nb = va_arg(c, const long int);
    char *temp = NULL;
